 ...
 ***************************************************************************************************************************************************************************** 
 */
public class UserMyCommentAdapter extends CommonAdapter<MessageBean> {

	SimpleDateFormat simpleDateFormat;
	public UserMyCommentAdapter(Context mContext, List<MessageBean> list) {
		super(mContext, list);
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView = mInflater.inflate(R.layout.adapter_user_my_comment, parent, false);
...
//				viewHolder.text_reply_username.setText(replyComment.getNick()+"  回复了你的短评：");
