package com.open.tencenttv.widget.androidtagview;
...
//        void onItemPreSelected(TagContainerLayout parent, View itemView, int position);
//
//        void onItemSelected(TagContainerLayout parent, View itemView, int position);
//
//        void onReviseFocusFollow(TagContainerLayout parent, View itemView, int position);
//    }
...
//        int widthSpecMode = MeasureSpec.getMode(widthMeasureSpec);
    ...
    @SuppressLint("NewApi") private void initTagView(TagView tagView){
...
//                    if (null != mOnTagClickListener) {
//                        mOnTagClickListener.onTagClick((TagView)view, 0, "");
//                    }
//                }
//            }
//
...
//                        mItemView = view; // 选中的item.
//                        if (hasFocus) {
//                            mOnItemListener.onItemSelected(TagContainerLayout.this, view, 0);
//                        } else {
//                            mOnItemListener.onItemPreSelected(TagContainerLayout.this, view, 0);
//                        }
//                    }
//                }
//            }
//        };
    ...
    private int[] onGetNewPosition(View view){
        ...
        int top = view.getTop();
        int bestMatchLeft = mViewPos[(Integer)view.getTag() * 2];
        int bestMatchTop = mViewPos[(Integer)view.getTag() * 2 + 1];
    ...
    private class DragHelperCallBack extends ViewDragHelper.Callback{
        ...
        public void onViewReleased(View releasedChild, float xvel, float yvel) {
            ...
            onChangeView(releasedChild, posRefer, (Integer) releasedChild.getTag());
