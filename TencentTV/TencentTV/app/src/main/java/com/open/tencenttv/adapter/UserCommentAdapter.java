 ...
 ***************************************************************************************************************************************************************************** 
 */
public class UserCommentAdapter extends CommonAdapter<MessageBean> {

	SimpleDateFormat simpleDateFormat;
	public UserCommentAdapter(Context mContext, List<MessageBean> list) {
		super(mContext, list);
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView = mInflater.inflate(R.layout.adapter_user_comment, parent, false);
